...
export const IntroDetails = {
  ...
  RESUME:
    "https://drive.google.com/file/d/1Qs7FaBQf6LhUJYYlfX5qvjSFbx5z7vRg/view?usp=sharing",
...
export const Interests = [
  {
    ...
    content:
      "I am passionate about creating visually appealing and user-friendly web experiences through clean, responsive, and interactive code. I focus on building seamless interfaces that are both aesthetically pleasing and highly intuitive for users.",
  },
  {
    header: "Innovative Problem Solving",
    content:
      "I thrive on innovative problem-solving, finding creative and efficient solutions to complex challenges. I enjoy thinking outside the box to turn problems into opportunities for growth and continuous improvement.",
  },
  {
    header: "Javascript",
    content:
      "I am a passionate Frontend Developer with a deep enthusiasm for JavaScript, the core of modern web development. I love exploring new frameworks and libraries to create dynamic, user-friendly interfaces and push the limits of what’s possible in the browser.",
  },
];
...
export const ProjectsData = [
  ...
  },
  {
    ...
    name: "Resume Builder",
    description:
      "Built an interactive Resume Builder web application leveraging React and the Context API, enabling users to effortlessly create professional resumes through a dynamic and intuitive form interface. Integrated advanced features such as real-time preview, customizable templates, and PDF export functionality to enhance user experience and usability. The application has been successfully utilized by over 50 individuals during college placement seasons, aiding in streamlined and effective presentation of qualifications and skills.",
